  ...
  return (
    <div className="bg-[#F6F6F6] rounded-lg shadow-md w-full flex flex-col items-start gap-1 pb-3">
      ...
      <div className="flex justify-between items-center w-full pr-3 pl-4 pt-4">
        <h2 className="text-md font-medium text-gray-800">Marcar Presença</h2>
        ...
        >
          ...
          <div className="flex justify-center">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-3 h-3 border border-[#C288B3] rounded-[3px] bg-white peer-checked:bg-[#C288B3]"></div>
            </label>
          </div>
        </div>
      ))}
