...
export default function AllProjects({ nome, quantidade }: AllProjectsProps) {
  ...
  return (
    <div className="w-full h-full flex items-center md:gap-3">
      ...
      <div className="flex w-full flex-col md:gap-3 items-start">
        <p className="text-white">Olá, professor(a) {nome}!</p>
        ...
        <p className="text-2xl md:text-4xl text-white">
          ...
          <br className="md:flex hidden" /> em{" "}
          <span className="text-[#E6C2D1]">andamento!</span>
        </p>

        <button
          onClick={() => router.push("/all-projects")}
          className="text-white bg-[#3B3B3B] py-1 px-5 rounded-full flex items-center gap-2 text-sm md:text-xl mt-3 cursor-pointer"
        >
          Ver todos
