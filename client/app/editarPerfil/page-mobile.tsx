...
export default function EditarPerfilMobile() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F8F3FB] px-4 py-8">
      ...
      <main className="bg-white rounded-[28px] ring-1 ring-black/5 shadow-md p-6">
        <h2 className="text-[20px] font-semibold text-[#6B217E] mb-6 text-center">Editar Perfil</h2>
        ...
        <textarea
          ...
          className="w-full border rounded-lg px-4 py-2 text-sm text-[#383838] focus:ring-2 focus:ring-[#9B4ACB] mb-6"
        />
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className="px-6 py-2 rounded-full text-[#383838] font-medium ring-1 ring-gray-300 hover:bg-gray-100 transition"
          >
            Cancelar
          </button>
          <button
